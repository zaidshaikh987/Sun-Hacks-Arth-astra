...
You are a senior full-stack product architect and UI/UX expert.

I will give you a project idea. Your task is to convert it into a **production-grade frontend system + product concept**, similar in depth and quality to a hackathon-winning project.

---

## 🎯 OBJECTIVE

Design a **high-quality, modern web application frontend + concept** that is:
...
* Target users
* Core idea (clear + impactful)

---

### 2. 🚀 CORE FEATURES (structured)

List 6–10 features with:
...
* Color palette
* Typography
* UI style (glassmorphism / minimal / neon / etc.)
...
### 5. 🤖 AI / SMART FEATURES (VERY IMPORTANT)
...
Suggest relevant APIs/tools:

* AI (Gemini / OpenAI)
* Database (MongoDB / Firebase)
* External APIs based on domain

---

### 7. ⚡ WOW FACTOR (CRITICAL)

Add 1–2 standout features that make this project unique:
...
### 8. 🧾 SAMPLE UI DESCRIPTION

Describe how UI looks visually:
...
* Make it look like a real product spec
* Prioritize clarity + impact
...
Generate a response so strong that it looks like a **top 1% hackathon project idea + frontend system**
